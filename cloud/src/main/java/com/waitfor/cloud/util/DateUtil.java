...
public class DateUtil {
    ...
    /**
     * 得到现在时间 yyyy-MM-dd HH:mm:ss +N天
     * YD
     */
    public static String getNowDateSSDay(int lease) {
    	Date d = new Date();
    	d.setDate(d.getDate()+lease);
        SimpleDateFormat format  = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String currdate = format.format(d);
        /*Calendar ca = Calendar.getInstance();
        ca.setTime(isToDate(currdate));
        ca.add(Calendar.DATE, lease);
        d = ca.getTime();
        String enddate = format.format(d);*/
        return currdate;
    }
    
    public static String getNowDateSSLease(String leaseTime,int lease) throws Exception {
    	SimpleDateFormat format  = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	    Date ltime=format.parse(leaseTime);
    	Date d = new Date();
    	d.setDate(ltime.getDate()+lease);
        String currdate = format.format(d);
        /*Calendar ca = Calendar.getInstance();
        ca.setTime(isToDate(currdate));
        ca.add(Calendar.DATE, lease);
